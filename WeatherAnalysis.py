...
with st.sidebar:
    st.markdown(':red[Temperature Thresholds]')
...
Figure_coniditional = get_hourly_data_figure(dbt_work_hours,global_colorset, hourly_data_st_month, hourly_data_st_day,
                hourly_data_st_hour, hourly_data_end_month, hourly_data_end_day,
                hourly_data_end_hour)

st.plotly_chart(Figure_coniditional, use_container_width=True)
